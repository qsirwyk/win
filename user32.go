...
func SetLayeredWindowAttributes(hWnd HWND, crKey COLORREF, bAlpha uint8, flags uint32) bool {
...
func UpdateLayeredWindow(hWnd HWND, hdcDst HDC, pptDst *POINT, pSize *SIZE, hdcSrc HDC, pptSrc *POINT, crKey COLORREF, pblend *BLENDFUNCTION, flags uint32) bool {
	ret, _, _ := syscall.Syscall9(updateLayeredWindow.Addr(), 9,
		...
		uintptr(crKey),
		//uintptr(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&pblend))))),
